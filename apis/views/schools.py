...
class StudentSubjectsScoreAPIView(APIView):
    ...
    def post(request, *args, **kwargs):
        ...
        rules:      - Score must be number, equal or greater than 0 and equal or less than 100.                     //  0 <= Score <= 100
                    - Credit must be integer, greater than 0 and equal or less than 3.                              // 0 < Credit <= 3
